...
const STAFF_LIST = [
  { name: "BS. Lương Đình Trung", email: "bsluongdinhtrung@gmail.com", role: "Trưởng khoa (Admin)" },
  { name: "BS. Đào Thị Nguyệt", email: "nguyethmu@gmail.com", role: "Phó khoa (Admin)" },
  { name: "BS. Lê Tuấn Anh", email: "drtuananh189@gmail.com", role: "Bác sĩ" },
  { name: "BS. Nguyễn Thị Ngân", email: "nguyenthingan.bsdk@gmail.com", role: "Bác sĩ" },
  { name: "KTV. Lương Thị Thùy Dung", email: "thuydung71@gmail.com", role: "Kỹ thuật viên" },
  { name: "KTV. Nguyễn Thị Thu Hương", email: "funny.monkeyhn345@gmail.com", role: "Kỹ thuật viên" },
  { name: "KTV. Trần Thị Vân", email: "tranvanbvdg@gmail.com", role: "Kỹ thuật viên" },
  { name: "KTV. Dương Văn Quang", email: "quangvictor@yahoo.com", role: "Kỹ thuật viên" },
  { name: "KTV. Lại Hải Hà", email: "laihaiha92@gmail.com", role: "Kỹ thuật viên" },
];
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full rounded-md border border-[#DDE3E0] bg-[#F7F8F6] pl-9 pr-3 py-2 text-sm text-[#12211F] placeholder:text-[#5C6B68]/60 focus:bg-white focus:border-[#1F5C55] focus:outline-none focus:ring-1 focus:ring-[#1F5C55] transition-all"
                  required
                />
              </div>
            </div>
            ...
            <div>
              <label className="block text-[11px] font-medium text-[#5C6B68] mb-1">
                Hoặc chọn nhanh nhân viên khoa:
              </label>
              <select
                value={email}
